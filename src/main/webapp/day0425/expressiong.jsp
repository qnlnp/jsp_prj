...
<head>
<meta charset="UTF-8">
<title>day0425/expressiong.jsp</title>
...
%>
<!--
	스크립틀렛(scriptlet)은,,, 그대로 
	표현식(Expression)은,,, JSP가 서블릿(Java)로 변경될때,,, out.print()로 변경된다.
	javax.servlet패키지 JspWriter클래스 print(), println() : 매개변수 하나짜리
-->
