...
<!-- 
	최초요청 param이 없어서 -> 로그인 form을 제공.
	세션이 존재하면, 로그아웃을 제공.
 -->

<!-- 
<c:choose>
<c:when test="${ empty sessionScope.name}"></c:when>
...
<form action="use_session_b.jsp" method="get">
	<label>이름</label>
	<input type="text" name="nameName" id="nameId"/>
	<input type="text" style="display: none;"/>
	<input type="button" value="입력" class="btn btn-success" id="btn"/>
</form>
<c:out value="${ sessionScope.name }">님, 로그인하셨습니다 반갑습니다~</c:out><br>
