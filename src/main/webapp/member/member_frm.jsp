		...
		$("#id").keyup(
				function(evt) {
					...
					if (id.length > 5) {
						...
						$.ajax({
							url : "ajax_id_dup.jsp", //요청을 받는 JSP URL
							type : "GET",
							data : param, //서버로 전송할,,, 데이터의 지정
							dataType : "JSON",
							error : function(xhr) {
								alert("버튼눌러서 팝업창으로 중복검사해주세요.");
								console.log(xhr.stauts);
							},
...
<body>
	...
	<main>
		<div id="subTitleDiv"><span id="subTitleSpan">회원가입</span></div><hr>
		<div id="container">
				...
				<table>
					...
					<tr>
						...
						<td><input type="password" class="inputBox"
							style="width: 200px" id="pass" name="pass"> 비밀번호 확인
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="tel"
							value="010-1234-5678"
							class="inputBox" style="width: 130px" maxlength="13"><input
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="email"
							...
							name="domain" value="naver.com"> <datalist id="domain">
								<option value="선택해주세요.">
								<option value="직접 입력">
