...
<style type="text/css"> 
  ...
  #background { width:502px; height:353px; background: #FFFFFF url(http://192.168.10.88/jsp_prj/member/images/id_background.png) no-repeat; }
  ...
  <div id="background">
    ...
    <div id="inputDiv2">
      <form name="subFrm2" id="subFrm2">
        ...
        <span id="showID"><c:out value="${ param.id }"/></span>는 사용이 
