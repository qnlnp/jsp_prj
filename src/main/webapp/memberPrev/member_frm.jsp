...
$(function(){
	...
	$('#chkID').click(function() {
	  ...
	  $('#selfIntro').keyup(function() {
	    ...
	    $('#wordCount').text($(this).val().length);//text
	  });
	  ...
	  $('#btnConfirm').click(function() {
		    ...
		    if ($('[name="email"]').val() == "") {
		      alert('이메일은 필수 입력입니다.');
		      $('[name="email"]').focus();//focus
		      return;
		    }//end if
		    
		    if ($('[name="zipcode"]').val() == "") {
		      alert('우편번호는 필수 입력입니다.');
		      $('[name="zipcode"]').focus();//focus
		      return;
		    }//end if
		    
		    if ($('[name="addr"]').val() == "") {
		      alert('주소는 필수 입력입니다.');
		      $('[name="addr"]').focus();//focus
		      return;
		    }//end if
...
<div id="container">
	...
	<iframe src="http://192.168.10.72/html_prj/css0410/scrollbar.html" 
	...
	<form action="member_process.jsp" name="frm" id="frm" method="post">
		<table>
			...
			<tr>
				<th>* 이름</th>
				<td colspan="3"><input type="text" class="inputBox" style="width:150px" name="name" value="sampleName"></td>
			</tr>
			<tr>
				<th>생일</th>
				<td colspan="3"><input type="text" class="inputBox" style="width:150px" name="birth" value="2025-01-13"></td>
			</tr>
			<tr>
				<th>연락처</th>
			...
			<tr>
				<th>* 휴대폰</th>
				<td colspan="3"><input type="text"  name="tel" class="inputBox" style="width:130px" value="010-2025-0113" maxlength="13"><input
					type="checkbox" name ="reception">수신</td>
			</tr>
			<tr>
				<th>* 이메일</th>
				<td colspan="3"><input type="text" name="email" class="inputBox" style="width:250px" value="sampleEmail">@
				<input type="text" list="domain" class="inputBox" style="width:150px" name="domain">
					<datalist id="domain" value="sampleDomain">
						<option value="선택해주세요.">
						<option value="직접 입력">
				...
				<input type="checkbox" name="reception2">수신</td>
			</tr>
			<tr>
				<th>* 성별</th>
				<td>
			...
			<input type="button" value = "우편번호검색" id="btnZipcode" value="12345"></td>
			</tr>
			
			<tr>
			<th>* 주소</th>
			<td><input type="text" id="addr" name="addr" readonly = "readonly" class="inputBox" style="width:500px" value="sampleAddr"><br>
				<input type="text" id="addr2" name= "addr2" class="inputBox" style="width:500px" value="sampleAddr2"/></td>
			</tr>
			<tr>
				<th>자기소개</th>
				<td>
				<textarea style="width:500px;height:100px" id="intro" name="intro" value="ㅇㅅㅇ"></textarea> 
