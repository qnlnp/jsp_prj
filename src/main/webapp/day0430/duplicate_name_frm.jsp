...
<li><label>radio</label>
 ...
 <li>
 	<input type="button" value="GET방식 전송" class="btn btn-primary"
 		id="btnGet"/>
 </li>
</ul>
</form>
...
<form name="frmPost" id="frmPost" action="duplicate_name_process.jsp" method="POST">
<ul>
<li><label>radio</label>
	<input type="radio" name="gender" value="M"/>남자 | 
	<input type="radio" name="gender" value="F"/>여자  
 ...
 <li>
 	<input type="button" value="POST방식 전송" class="btn btn-danger"
 		id="btnPost"/>
 </li>
</ul>
</form>
