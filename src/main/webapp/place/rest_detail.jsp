...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
//         center: new kakao.maps.LatLng(37.499317, 127.0332123),
...
<main>
<div id="subTitleDiv"><span id="subTitleSpan">맛집보기</span></div><hr>
<div id="container">
<div id="restWrap" style="width:80%; margin:0 auto">
	...
	<td colspan="2" style="font-size: 30px; text-align: center" >맛집 입력</td>
	 ...
	 -->
	<tr>
	<td style="width: 180px">식당명</td>
	<td><span><c:out value="${ rDTO.restaurant }"/></span></td>
	</tr>
	
	<tr>
	<td>대표메뉴</td>
	<td><span><c:out value="${ rDTO.menu }"/></span></td>
	</tr>
	
	<tr>
	<td>메뉴가격</td>
	<td><span><fmt:formatNumber value="${ rDTO.price }" pattern="#,###"/>원</span></td>
	</tr>
	
	<tr>
	<td>식당정보</td>
	<td><span><c:out value="${ rDTO.info }"/></span></td>
	</tr>
	
	<tr>
	<td>작성자 / 작성일</td>
	<td><span><c:out value="${ rDTO.id }"/> / <fmt:formatDate value="${ rDTO.input_date }" pattern="yyyy-MM-dd"/></span></td>
	</tr>
	...
	<td colspan="2" style="text-align: center">
		...
		<input type="button" value="식당정보추가" id="btnAdd" class="btn btn-success"/>
		 -->
		<a href="restaurant_list.jsp" class="btn btn-danger">맛집리스트</a>
		<!-- 검색하려는 키워드, currentPage -->
	</td>
	</tr>
