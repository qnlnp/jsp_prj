...
<head>
<meta charset="UTF-8">
<title>day0428/comment.jsp</title>
...
<ul>
<li>URL(Locator) : <%= request.getRequestURL() %></li>
<li>URI(Identifier) : <%= request.getRequestURI() %></li>
</ul>
...
<!-- 
HTML주석은,,, JSP>Java<class>인스턴스 생성> HTML로 만들어진다.
-->
 
<!-- 
Java주석은,,, class에 포함되지 않는다.
-->

<!-- 
JSP주석은,,, 아예 Java에 포함되지 않는다.
-->

HTML주석 : <!-- <%=name %> --><br>
Java주석 : <%= /*이것은 이름변수 임.*/ name %><br>
JSP주석 : <%-- <%= name %> --%>
